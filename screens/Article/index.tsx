...
export default function Article() {
  ...
  const { data, loading, error, refetch } = useQuery<UserArcticle>(
    GET_USER_ARTICLE,
      ...
      >
        <View style={styles.container}>
          ...
          <Text style={styles.title}>
            pour aider les autres à réduire leurs dépense carbone.
          </Text>
          <View style={styles.card}>
            <Text style={styles.text}>Ajout d'article</Text>
            <SafeAreaView>
              <AddArticle userId={userId} refetch={refetch} styles={styles} />
            </SafeAreaView>
          </View>
          <View style={styles.card}>
