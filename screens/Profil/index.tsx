                                ...
                                <View style={styles.centeredView}>
                                    <View style={styles.modalView}>
                                        ...
                                        <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                                            ...
                                            <Text>{isPasswordVisible ? <Ionicons size={25} name="eye-off-outline"  ></Ionicons> : <Ionicons size={25} name="eye-outline"></Ionicons>}</Text>
                                            </TouchableOpacity>
                                        </View>
                                        <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                                            <TextInput
                                            ...
                                            <Text>{isConfirmPasswordVisible ? <Ionicons size={25} name="eye-off-outline"  ></Ionicons> : <Ionicons size={25} name="eye-outline"></Ionicons>}</Text>
                                            </TouchableOpacity>
                                        </View>
                                        {passwordError ? (
